...
- 설치된 앱은 15,443,968 bytes, SHA-256 `61ACBDE61ED8FEFD180C2DE59819CA7013BE9383CDEB62CCFED4FE666E3A9483`이다. Tauri가 번들 유형 정보를 반영한 릴리스 경로 EXE와 NSIS 페이로드의 바이트 해시는 다르므로 설치 페이로드 해시를 운영 기준으로 기록한다.
- 큐 가시성 수정 설치 파일은 4,042,347 bytes, SHA-256 `071733C35B6E0EF172626AEEBD49B9558B4C9E98ECB3426CB0280C31919D455F`, 코드 서명 상태는 `NotSigned`다.
